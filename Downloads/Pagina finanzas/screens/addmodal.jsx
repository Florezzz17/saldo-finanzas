/* addmodal.jsx — add / edit transaction sheet. Exposes window.AddSheet */
function AddSheet({ editing, onClose }) {
  ...
  // reset category when switching type if it no longer fits
  React.useEffect(() => {
