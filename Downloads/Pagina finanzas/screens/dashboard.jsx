/* dashboard.jsx — main screen. Exposes window.Dashboard */
function Dashboard({ onAdd, onGoto, onOpenTx }) {
  const { fmt, month, balance, cats, catMap, txs, MONTHS, NOW } = useStore();
  ...
  return (
    <div className="screen-enter">
      ...
      <div className="pad" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: 4, paddingBottom: 16 }}>
        <div>
          <div style={{ fontSize: 13.5, color: "var(--text-2)", fontWeight: 600 }}>{greet}, Laura 👋</div>
