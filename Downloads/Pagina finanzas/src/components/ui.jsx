...
export function CatIcon({ cat, size = 42, radius = 13, iconSize }) {
...
export function TxRow({ tx, cat, onClick }) {
...
export function Donut({ data, size = 168, thickness = 22, children }) {
...
export function Bars({ data, max, height = 130, fmtFn }) {
